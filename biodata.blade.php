...
<input class="text_field"  name="no_ktp" placeholder="no_ktp" type="text">
<input class="text_field"   name="nama" placeholder="full_name" type="text">
<input class="text_field"    name="alamat" placeholder="alamat_skrg" type="text">
<input class="text_field"   name="alamat_ktp" placeholder="alamat_ktp" type="text">
<select class="text_field"  name="agama" placeholder="agama" type="text"> 
...
<select class="text_field" name="status_perkawinan" placeholder="jenis_kelamin" type="text"> 
...
<input class="text_field" name="hobi" placeholder="hobi" type="text">
<input class="text_field"  name="suku" placeholder="suku" type="text">
<input class="text_field"  name="no_tlp" placeholder="no_tlp" type="text">
<input class="text_field"  name="no_hp" placeholder="no_hp" type="text">
<input class="text_field"  name="no_sim" placeholder="no_sim" type="text">
...
<input class="text_field" id ="sekolah" name="sekolah" placeholder="masukan nama sekolah/universitas" type="text">
<input class="text_field"  id ="sekolah"  name="th_masuk" placeholder="Tahun masuk" type="text">
<input class="text_field"  id ="sekolah"  name="th_keluar" placeholder="Tahun keluar" type="text">
<label> Pendidikan Non Formal </label>
<input class="text_field"  id ="sekolah"  name="jenis_pendidikan" placeholder="Jenis Pendidikan" type="text">
<input class="text_field"  id ="sekolah"  name="penyelengara" placeholder="penyelengara" type="text">
<input class="text_field"  id ="sekolah"  name="durasi" placeholder="Lama Pendidikan" type="text">
...
<input class="text_field" name="nama_ibu" placeholder="Masukan Nama Ibu" type="text">
<input class="text_field" name="alamat_ortu" placeholder="Alamat ibu" type="text">
