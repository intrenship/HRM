...
Route::group(['middleware' => ['web','auth']], function(){
	...
	Route::get('/add_daylireport', 'adminController@create_daylireport');
	...
	Route::get('/query_karyawan', 'adminController@search_report');
	Route::get('/add_karyawan', 'adminController@create_karaywan');
	Route::get('/edit_karyawan/{id}', 'adminController@edit_karyawan');
	Route::get('/view_karyawan', 'adminController@views_karyawan');
	Route::get('/view_report_karyawan', 'adminController@report_karyawan');
	Route::get('/delete_karyawan/{id}', 'adminController@destroy_karyawan');
	Route::post('/karyawan_insert', 'adminController@insert_karyawan');
	Route::post('/daylireport_insert', 'adminController@insert_daylireport');
	...
	Route::post('/update_lamaran/{id}', 'adminController@update_lamaran');
	...
	Route::get('/viewlamaran/{id}', 'adminController@viewlamaran1');
